...
const FeatureCard: React.FC<FeatureCardProps> = ({ title, description, image }) => {
	return (
		<div className="bg-gradient-to-r from-[#DDF346] to-[#84EA0700] p-[1px] rounded-xl h-full hover:shadow-xl transition-all duration-300 hover:scale-105 relative overflow-hidden group">
			<div className="bg-[var(--bg-block)] rounded-xl p-8 shadow-xl cursor-pointer h-full">
				{/* Icon container */}
...
const AboutPage = () => {
	return (
		<ReactQueryProvider>
			<ThemeProvider>
				<ToastContainer />
				<div className="h-screen relative bg-[var(--background)] overflow-auto font-space">
					<Header />
					...
					<div className={`mt-0 md:mt-14 relative text-[var(--foreground)]`}>
						{/* Section 1 */}
						<motion.div
							...
							<div className="relative">
								<div className="relative space-y-6 px-6 md:px-0 py-20 container mx-auto z-30">
									...
									<div className="flex flex-col md:flex-row items-center gap-6 justify-center">
										...
										>
											<div className="relative bg-[var(--background)] text-[var(--foreground)] rounded px-8 py-4 font-medium flex items-center gap-2">
												<p>Start Free Demo</p>
												<PlayIcon />
											</div>
										</motion.div>
								...
								<div className="grid grid-cols-1 md:grid-cols-3 gap-10">
									{section2.map((item, index) => (
										<div key={index} className="grid grid-cols-1 bg-gradient-to-r from-[#DDF346] to-[#84EA0700] p-[1px] rounded-xl shadow-xl cursor-pointer hover:shadow-xl transition-all duration-300 hover:scale-105 group overflow-hidden">
											<div className="p-7.5 rounded-xl h-full relative bg-[var(--background)]">
												<div className="flex justify-end mb-6 text-[var(--foreground)]">
													{item.icon}
												</div>
						...
						<motion.div
							...
							viewport={{ once: true, amount: 0.3 }}
						>
							<div className="bg-[var(--border-popover)] relative">
