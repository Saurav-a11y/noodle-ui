				...
				<div className="relative">
					<div className="space-y-6 px-6 md:px-0 py-20 container mx-auto">
						...
						<div className="flex flex-col md:flex-row items-center gap-6 justify-center">
							<div className="bg-gradient-to-r from-[#DDF346] to-[#84EA07] p-[1px] rounded cursor-pointer">
								<div className="relative bg-[#f9f9f9] dark:bg-[#1A1A1A] dark:text-[#FFFFFF] rounded px-8 py-4 font-medium flex items-center gap-2">
									<p>Start Free Demo</p>
									<PlayIcon />
								</div>
							</div>
							<div className="bg-gradient-to-r from-[#DDF346] to-[#84EA07] px-8 py-4 rounded font-medium cursor-pointer flex items-center gap-2 text-black">
