                    ...
                    <div className="container mx-auto px-6 mt-10 md:mt-20 relative bg-transparent space-y-10 mb-10">
                        <div>
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                <TopGrowthList assetType="commodities" />
                                <MostTalkedAboutList assetType="commodities" />
                                <div className="flex gap-4 flex-col">
                                    <NumberTrackedList assetType="commodities" />
                                    <TotalActiveUsersList assetType="commodities" />
                                </div>
                            </div>
                        </div>
