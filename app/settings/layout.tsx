										...
										return (
											<Link
												...
												className={cn(
													...
													active
														? 'bg-[#DDF346] text-[var(--bg-card)] font-medium'
														: 'hover:bg-black/[0.04] dark:hover:bg-white/[0.06] text-[var(--text)]'
												)}
											>
												...
												{/* {s.badge && (
												<span className="text-xs rounded-md bg-[var(--bg-card)] px-2 py-0.5">
													{s.badge}
												</span>
											)} */}
											</Link>
