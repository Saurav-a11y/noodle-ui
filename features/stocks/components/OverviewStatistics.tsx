	...
	return (
		<div>
			...
			<div className="grid grid-cols-1 lg:grid-cols-3 gap-6 text-[#1E1B39]">
				...
				<OverviewCard data={topGrowthStocks7d} title="Top Gaining Project (Growth Rate - 7d)" tooltip="The list of stocks with the highest price growth rate over the past 7 days, calculated based on percentage change." isLoading={isGettingTopGrowthStocks} />
