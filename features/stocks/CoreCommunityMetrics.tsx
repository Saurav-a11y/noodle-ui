			...
			<div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
				<div className="rounded-xl p-4 space-y-1 bg-[var(--bg-block)] text-[var(--text)]">
					...
					{isFetching ?
						...
						: <>
							<div className="text-xl font-semibold font-noto text-[var(--text)] mb-2">{formatNumberShort(stockOverview?.core_metrics?.active_users_30d?.value)}</div>
				...
				<div className="rounded-xl p-4 space-y-1 bg-[var(--bg-block)] text-[var(--text)]">
					...
					{isFetching ?
						...
						: <>
							<div className="text-xl font-semibold font-noto mb-2">{stockOverview?.core_metrics?.engagement_rate_7d?.value}</div>
				...
				<div className="rounded-xl p-4 space-y-1 bg-[var(--bg-block)] text-[var(--text)]">
					...
					{isFetching ?
						...
						: <>
							<div className="text-xl font-semibold font-noto mb-2">{stockOverview?.core_metrics?.growth_rate_30d?.value}</div>
				...
				<div className="rounded-xl p-4 space-y-1 bg-[var(--bg-block)] text-[var(--text)]">
					...
					{isFetching ?
						...
						: <>
							<div className="text-xl font-semibold font-noto mb-2">{Math.floor(Math.random() * 101)}</div>
