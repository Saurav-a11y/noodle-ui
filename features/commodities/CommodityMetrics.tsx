			...
			<div className="text-[#1E1B39">
				<div className="rounded-xl p-4 mb-4 bg-[var(--bg-block)] text-[var(--text)]">
					...
					{isFetching ? (
						...
						<div className="flex items-center gap-2">
							<p className="text-3xl font-semibold font-noto">{commodityOverview?.health_score?.value}</p>
				...
				<div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
					<div className="rounded-xl p-4 space-y-1 bg-[var(--bg-block)] text-[var(--text)]">
						...
						{isFetching ? <div className="h-5 w-full bg-[var(--loading)] rounded animate-pulse" /> : <div className="text-sm font-medium font-noto flex items-center gap-1" style={{ color: commodityOverview?.badges?.authentic_engagement?.color }}>{commodityOverview?.badges?.authentic_engagement?.name}</div>}
					</div>
					<div className="rounded-xl p-4 space-y-1 bg-[var(--bg-block)] text-[var(--text)]">
						<CommunityGrowthIcon />
						<div className="flex items-center gap-2 mb-2">
						...
						{isFetching ? <div className="h-5 w-full bg-[var(--loading)] rounded animate-pulse" /> : <div className="text-sm font-medium font-noto flex items-center gap-1 text-[var(--text)]">{commodityOverview?.community_growth?.value}{commodityOverview?.community_growth?.unit} {commodityOverview?.community_growth?.period}</div>}
					</div>
					<div className="rounded-xl p-4 space-y-1 bg-[var(--bg-block)] text-[var(--text)]">
						...
						{isFetching ? <div className="h-5 w-full bg-[var(--loading)] rounded animate-pulse" /> : <div className="text-sm font-medium font-noto flex items-center gap-1 text-[var(--text)]">{commodityOverview?.recent_activity_drop?.value}{commodityOverview?.recent_activity_drop?.unit} {commodityOverview?.recent_activity_drop?.period}</div>}
					</div>
				</div>
			</div>
				...
				<div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
					<div className="rounded-xl p-4 space-y-1 bg-[var(--bg-block)] text-[var(--text)]">
						...
						{isFetching ?
							...
							: <>
								<div className="text-xl font-semibold font-noto text-[var(--text)] mb-2">{formatNumberShort(commodityOverview?.core_metrics?.active_users_30d?.value)}</div>
					...
					<div className="rounded-xl p-4 space-y-1 bg-[var(--bg-block)] text-[var(--text)]">
						...
						{isFetching ?
							...
							: <>
								<div className="text-xl font-semibold font-noto text-[var(--text)] mb-2">{commodityOverview?.core_metrics?.engagement_rate_7d?.value}{commodityOverview?.core_metrics?.engagement_rate_7d?.unit}</div>
								<p className="text-sm font-medium font-noto text-[var(--text)]">{commodityOverview?.core_metrics?.engagement_rate_7d?.change_percent}%</p>
							</>
						}
					</div>
					<div className="rounded-xl p-4 space-y-1 bg-[var(--bg-block)] text-[var(--text)]">
						...
						{isFetching ?
							...
							: <>
								<div className="text-xl font-semibold font-noto text-[var(--text)] mb-2">{commodityOverview?.core_metrics?.growth_rate_30d?.value}{commodityOverview?.core_metrics?.growth_rate_30d?.unit}</div>
								<p className="text-sm font-medium font-noto text-[var(--text)]">{commodityOverview?.core_metrics?.growth_rate_30d?.trend}</p>
							</>
						}
					</div>
				</div>
					...
					<div className="rounded-xl p-4 space-y-1 bg-[var(--bg-block)] text-[var(--text)]">
						...
						{!isFetching ? (
							<>
								...
								<p className="text-sm font-medium font-noto text-[var(--text)]">
							...
							<>
								<div className="h-7 w-1/2 bg-gray-200 bg-[var(--loading)] rounded animate-pulse mb-2" />
								<div className="h-5 w-full bg-gray-200 bg-[var(--loading)] rounded animate-pulse" />
							</>
						)}
					</div>
					<div className="rounded-xl p-4 space-y-1 bg-[var(--bg-block)] text-[var(--text)]">
