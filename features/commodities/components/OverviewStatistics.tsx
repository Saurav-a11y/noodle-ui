...
const topGrowthCommodities7d = [
    { rank: 1, symbol: 'CO', name: 'Crule Oil', growth_rate_percent: 14, medium_logo_url: <OilIcon /> },
    { rank: 2, symbol: 'HO', name: 'Heating Oil', growth_rate_percent: 12, medium_logo_url: <OilIcon /> },
    { rank: 3, symbol: 'TG', name: 'TTF Gas', growth_rate_percent: 8, medium_logo_url: <GasIcon /> },
    { rank: 4, symbol: 'UG', name: 'UK Gas', growth_rate_percent: 6, medium_logo_url: <GasIcon /> },
    { rank: 5, symbol: 'ET', name: 'Ethanol', growth_rate_percent: 2, medium_logo_url: <EthanolIcon /> },
]
    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 text-[#1E1B39]">
                ...
                <ProjectList
                    title="Top Growth Commodities (Growth Rate - 7d)"
