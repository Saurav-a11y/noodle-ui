...
const AgriculturalCommoditiesOverview = ({ data, isLoading }) => {
	...
	return (
		<div className="p-5 bg-white dark:bg-black rounded-xl shadow-xl">
			<p className="text-lg font-medium font-reddit mb-5 dark:text-white">Agricultural Commodities Overview</p>
						...
						{isLoading
							...
							: _map(data, (agricultural, index) => (
								<TableRow
									...
									onClick={() => router.push(`/commodities/${agricultural.name_slug}`)}
								>
