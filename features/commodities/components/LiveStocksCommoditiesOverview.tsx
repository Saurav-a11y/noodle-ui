...
const LiveStocksCommoditiesOverview = ({ data, isLoading }) => {
    const router = useRouter();
    return (
        <div className="p-5 bg-white dark:bg-black rounded-xl shadow-xl">
            <p className="text-lg font-medium font-reddit mb-5 dark:text-white">Livestocks Commodities Overview</p>
                    ...
                    <TableHeader className="dark:bg-[#1A1A1A]">
                        <TableRow className="border-b border-b-[#C9C9C9]">
                            ...
                            <TableHead className="border-b border-b-[#C9C9C9] dark:border-b-[#4A4A4A]">
                                <p className="text-xs text-[#4B4A4A] dark:text-[#FFF] font-noto">LiveStocks</p>
                            </TableHead>
                        ...
                        {isLoading
                            ...
                            : _map(data, (metal, index) => (
                                <TableRow
                                    ...
                                    onClick={() => router.push(`/commodities/${metal.name_slug}`)}
                                >
...
export default LiveStocksCommoditiesOverview