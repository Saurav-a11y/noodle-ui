...
import AICommunityAnalyst from "@/features/cryptocurrency-detail/components/ChatWithCryptoAssistant";
...
export const AssetDetailLayout = ({ children }: AssetDetailLayoutProps) => {
    ...
    <ReactQueryProvider>
      ...
      <div className="h-screen flex">
        ...
        <div className="h-full w-full overflow-auto relative bg-[#F9F9F9] dark:bg-[#0B0B0B]">
          ...
          {/* 👇 Đây là chỗ để bạn inject phần content riêng cho mỗi page */}
