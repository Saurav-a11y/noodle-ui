			...
			<div className="flex items-center gap-2 mb-4 border-b border-[#C5C5C5] overflow-scroll">
				{tabs.map((tab) => (
					<button
						...
						className={`border-b-2 px-4 py-2 text-sm text-[#373737] font-medium transition-all duration-200 cursor-pointer font-reddit hover:bg-[#F0F0F0] hover:rounded-t ${activeTab === tab
						...
						{(activeTab === "All Activity" || activeTab === "Twitter") && (
							<div className="bg-[#F6F6F6] p-4 rounded-xl">
								<div className="flex items-center justify-between mb-2 md:mb-4 space-x-2">
									...
									<button className="text-xs bg-white px-2 py-1.5 rounded cursor-pointer font-reddit hidden md:block hover:bg-[#F0F0F0] transition-colors duration-200">View all on Twitter</button>
								</div>
								<div className="flex items-center block md:hidden justify-between mb-4">
									...
									<button className="text-xs bg-white px-2 py-1.5 rounded cursor-pointer font-reddit hover:bg-[#F0F0F0] transition-colors duration-200">View all on Twitter</button>
								</div>
						...
						{(activeTab === "All Activity" || activeTab === "GitHub") && (
							<div className="bg-[#F6F6F6] p-4 rounded-xl">
								<div className="flex items-center justify-between mb-2 md:mb-4 space-x-2">
									...
									<button className="text-xs bg-white px-2 py-1.5 rounded cursor-pointer font-reddit hidden md:block hover:bg-[#F0F0F0] transition-colors duration-200">View Repository</button>
								</div>
								<div className="flex items-center justify-between block md:hidden mb-4">
									...
									<button className="text-xs bg-white px-2 py-1.5 rounded cursor-pointer font-reddit hover:bg-[#F0F0F0] transition-colors duration-200">View Repository</button>
								</div>
						...
						{(activeTab === "All Activity" || activeTab === "Reddit") && (
							<div className="bg-[#F6F6F6] p-4 rounded-xl">
								<div className="flex items-center justify-between mb-2 md:mb-4 space-x-2">
									...
									<button className="text-xs bg-white px-2 py-1.5 rounded font-reddit hidden md:block cursor-pointer hover:bg-[#F0F0F0] transition-colors duration-200">View all on Reddit</button>
								</div>
								<div className="flex items-center justify-between mb-4 md:hidden">
									<span className="ml-3 text-xs text-[#373737] font-reddit"><b>156</b> posts today</span>
									<button className="text-xs bg-white px-2 py-1.5 rounded font-reddit cursor-pointer hover:bg-[#F0F0F0] transition-colors duration-200">View all on Reddit</button>
								</div>
						...
						{(activeTab === "All Activity" || activeTab === "Youtube") && (
							<div className="bg-[#F6F6F6] p-4 rounded-xl">
								<div className="flex items-center justify-between mb-2 md:mb-4 space-x-2">
									...
									<button className="text-xs bg-white text-[#373737] px-2 py-1.5 rounded font-reddit hidden md:block cursor-pointer hover:bg-[#F0F0F0] transition-colors duration-200">View Channel</button>
								</div>
								<div className="flex items-center justify-between mb-4 md:hidden">
									<span className="ml-3 text-xs text-[#373737] font-reddit"><b>18</b> videos this week</span>
									<button className="text-xs bg-white text-[#373737] px-2 py-1.5 rounded font-reddit cursor-pointer hover:bg-[#F0F0F0] transition-colors duration-200">View Channel</button>
								</div>
											...
											<div className="flex items-start gap-3">
												...
												<div className="flex-1">
													<div className="mb-1 space-y-1">
														...
														<div className="flex items-center gap-2 text-[#4B4A4A] font-noto hidden md:flex">
														...
														<div className="flex items-center gap-4 text-xs font-noto text-[#4B4A4A] hidden md:flex">
